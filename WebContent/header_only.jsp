...
<div id="wrapper">
 <div id="tooplate_mid_wrapper">
  ...
  <h1><center>Library & Resource Center</center></h1>
      <div id="apDiv1"><a href="mybooks.jsp"> <img src="img/MyBooks.png"></a></div>
      <div id="apDiv2"><a href="signup.jsp"> <img src="img/student_login.png"></a></div>
      <div id="apDiv6">Search Books By Department</div>
      <div id="apDiv7">
      <form method="post" action='book_search.jsp'>
        <input type="radio" name="radios" value="radio1" checked>&nbsp;&nbsp;Mechanical Engineering
        <br>
        <input type="radio" name="radios" value="radio2">&nbsp;&nbsp;Electrical Engineering
        <br>
        <input type="radio" name="radios" value="radio3">&nbsp;&nbsp;Computer Science Engineering
        <br>
        <input type="radio" name="radios" value="radio4">&nbsp;&nbsp;IT Engineering
        <br>
        <input type="radio" name="radios" value="radio5">&nbsp;&nbsp;E & C Engineering
        <br>
        <input type="radio" name="radios" value="radio6">&nbsp;&nbsp;Chemical Engineering
        <br>
        <input type="radio" name="radios" value="radio7">&nbsp;&nbsp;Metallurgy Engineering
        <br><br>
